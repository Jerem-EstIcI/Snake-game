...
function gameOver() {
    ...
    if (score > bestScore) {
        bestScore = score; // Update M
        localStorage.setItem('bestScore', bestScore); // Sauvegarde le meilleur score dans le local storage
    }
...
function draw() {
    ...
    ctx.fillText("Best: " + bestScore, canvasWidth - 100, 30); // Affiche le meeilleur score
}
